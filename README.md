...
```bash
mkdir -p ~/.config/opencode/skills/ragtime-architecture ~/.agents/skills/writing-docs ~/.opencode
...
- **External skills** in `~/.agents/skills/` other than `writing-docs` (prisma, docker, stop-slop, senior-engineering, superpowers): installed via their respective package managers
